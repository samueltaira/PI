...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('../assets/css/main.css', true)}}">
    ...
    <!-- CSS header -->
    <link rel="stylesheet" href="{{asset('../assets/css/demo.css', true)}}">
    <link rel="stylesheet" href="{{asset('../assets/css/header-fixed.css', true)}}">
    <link href='https://fonts.googleapis.com/css?family=Cookie' rel='stylesheet' type='text/css'>

    <!-- CSS footer-->
    <link rel="stylesheet" href="{{asset('../assets/css/footer.css', true)}}">
