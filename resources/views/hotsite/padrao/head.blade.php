...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{secure_asset('../assets/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')}}">
    ...
    <link rel="stylesheet" href="{{secure_asset('../assets/css/header-fixed.css')}}">
